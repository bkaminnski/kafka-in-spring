...
@Configuration
public class ForwardingWithDbConsumerConsumerConfig {

    private static Logger logger = LoggerFactory.getLogger(ForwardingWithDbConsumerConsumerConfig.class);
    ...
    @Autowired
    private ForwardingWithDbConsumerConsumerErrorHandler errorHandler;
